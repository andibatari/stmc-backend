...
class AuthController extends Controller
{
    ...
    // ===============================
    // HELPER PROFILE DATA (MENGGUNAKAN GCS)
    // ===============================
    ...
    protected function getProfileData($loginUser)
    {
        ...
        if ($loginUser instanceof EmployeeLogin) {
            ...
            return $karyawan ? [
                ...
                // 🌟 KEMBALI MENGGUNAKAN URL GCS BULAT
    ...
    /**
     * UPDATE PROFILE INTERFACES (DENGAN AKOMODASI GCS)
     */
    public function updateProfile(Request $request)
    {
        try {
            ...
            if ($request->hasFile('foto_profil')) {
                ...
                if ($file->isValid()) {
                    // Hapus foto lama di GCS jika ada
                    ...
                    } catch (\Exception $gcsException) {
                        return response()->json([
                            'status' => 'error',
                            'message' => 'GCS Cloud Error: ' . $gcsException->getMessage(),
                            'bantuan' => 'Periksa apakah nama disk di config/filesystems.php sudah tepat atau pastikan Uniform Bucket Access melarang ACL perubahan statis.'
                        ], 500);
                    }
                }
            }
            ...
            return response()->json([
                'status' => 'success',
                'message' => 'Profil berhasil diperbarui melalui Google Cloud Storage',
