                    ...
                    <ul>
                        ...
                        <li class="my-1">
                            ...
                            <ul id="submenuAdmin" class="sub-menu pl-8 mt-1 {{ request()->routeIs(['admin.create', 'admin.tambah-dokter', 'paket-poli']) ? 'block' : 'hidden' }}">
                                ...
                                <li class="my-1">
                                    <a href="{{ route('admin.antrean-poli') }}" class="sidebar-link flex items-center p-4 text-gray-200 hover:bg-red-700 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.antrean-poli') ? 'active' : '' }}">
                                ...
                                <li class="my-1">
                                    <a href="{{ route('admin.laporan.pemeriksaan') }}" class="sidebar-link flex items-center p-4 text-gray-200 hover:bg-red-700 rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.laporan.pemeriksaan') ? 'active' : '' }}">
