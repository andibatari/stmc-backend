    ...
    <div class="bg-slate-50 p-4 md:p-6 rounded-xl border border-slate-100">
        ...
        <div class="grid grid-cols-3 gap-3 md:gap-4 mt-4 pt-3 border-t border-slate-200">
            ...
            <div>
                ...
                <input type="number" wire:model="tinggi_badan" class="block w-full px-3 py-2 text-xs font-bold rounded-lg border border-slate-200 bg-white">
            </div>
            <div>
                <label class="block text-[9px] md:text-xs font-bold text-slate-600 mb-1">Berat Badan (kg)</label>
                <input type="number" wire:model="berat_badan" class="block w-full px-3 py-2 text-xs font-bold rounded-lg border border-slate-200 bg-white">
            </div>
        </div>
    </div>
